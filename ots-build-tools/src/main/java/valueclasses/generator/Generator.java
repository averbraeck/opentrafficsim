...
public class Generator
{
    ...
    public static BufferedWriter openFile(String relativePackage, String name, String description)
    {
        ...
        String fileName = buildDir + packageBaseName + "." + relativePackage + "." + name + ".java";
        try
        {
            writer = new BufferedWriter(new FileWriter(new File(fileName)));
            writer.write("package " + packageBaseName + ";\r\n\r\n");
            writer.write("/**\r\n * "
                    + description
     ...
     */
    private static void generateAbstractClass(String relativePackage, String name, String description, String typeInfo, String contents)
    {
        try
        {
