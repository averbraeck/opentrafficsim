...
import org.opentrafficsim.animation.colorer.SpeedColorer;
...
public class SpeedTrajectoryColorer extends SpeedColorer<TrajectorySection> implements TrajectoryColorer
{
    ...
    /** Value function. */
    private static final Function<TrajectorySection, Optional<Speed>> VALUE =
            (traj) -> Optional.ofNullable(Speed.ofSI(traj.trajectory().getV(traj.section())));
