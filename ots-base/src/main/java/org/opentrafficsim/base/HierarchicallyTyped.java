...
/**
 * HierarchicallyTyped is the interface of objects that are of a HierarchicalType. Examples are Gtu (of type GtuType), Link (of
 * type LinkType), and Detector (of type DetectorType). By making these objects HierarchicallyTyped, they can return their
 * correct 'type' as well as check whether they belong to a certain hierarchical type.
 * <p>
