...
4. Different task managers, including simple summation of tasks, or implementing the concept of anticipation reliance ([Calvert et al., 2020](../98-references/references.md)).
