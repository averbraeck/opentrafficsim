...
The default tactical planner is the Lane change Model with Relaxation and Synchronization (LMRS) ([Schakel et al., 2012](../98-references/references.md)). This section discusses what modules it uses and how it can be extended.
