...
/**
 * This interface allows on screen items to <b>not</b> obtain colors and/or the font from an {@link Appearance}. This can be
 ...
 * <br>
 * The default implementation of the methods in this interface return {@code false}, meaning the {@link Appearance} is
 * completely ignored. In order to ignore it only partially, some methods should be overridden to return true. An example of
 * this is given below, which will only allow the font of the {@link Appearance}. It also shows a convenient way to implement
...
public interface AppearanceControl extends nl.tudelft.simulation.dsol.swing.gui.appearance.AppearanceControl
{
    ...
    /** Default font size. */
    OptionalInt DEFAULT_FONT_SIZE = OptionalInt.of(12);

    /**
     * Returns the font size. May be {@code null} to ignore font size.
     * @return font size, may be empty to ignore font size from appearance
     */
    default OptionalInt getFontSize()
    {
