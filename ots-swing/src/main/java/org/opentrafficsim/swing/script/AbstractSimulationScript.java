...
public abstract class AbstractSimulationScript implements EventListenerInterface
{
    ...
    //
    // /**
    // * Sets the default properties. Can be overridden and use method {@code setProperty()}. Default implementation does
    // nothing.
    // */
    ...
    //
    // /**
    // * Sets up the simulation based on provided properties. Properties can be obtained with {@code getProperty()}. Setting up
    // a
    // * simulation should at least create a network and some demand. Additionally this may setup traffic control, sampling,
    // etc.
    // * @param sim OTSSimulatorInterface; simulator
    // * @return OTSNetwork; network
