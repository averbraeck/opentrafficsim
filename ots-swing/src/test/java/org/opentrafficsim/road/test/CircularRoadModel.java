...
public class CircularRoadModel extends AbstractOTSModel implements UNITS
{
    ...
    public void constructModel() throws SimRuntimeException
    {
        try
        {
            ...
            double radius = ((InputParameterDoubleScalar<LengthUnit, Length>) getInputParameter("generic.trackLength"))
                    .getTypedValue().si / 2 / Math.PI;
            double headway = 40;
            double headwayVariability = 0;

            String carFollowingModelName = "IDM+";
            Acceleration a = Acceleration.createSI(1.25);
            Acceleration b = Acceleration.createSI(2.09);
            Length s0 = Length.createSI(3.0);
