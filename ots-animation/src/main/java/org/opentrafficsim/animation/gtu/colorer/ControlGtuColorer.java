...
import org.opentrafficsim.road.gtu.lane.tactical.Controllable.State;
...
public class ControlGtuColorer extends AbstractLegendColorer<Gtu, State>
{
    ...
    {
        super((gtu) -> gtu.getTacticalPlanner() instanceof Controllable contr ? contr.getControlState() : null,
