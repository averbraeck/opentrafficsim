 ...
 */
public class IMBSuperDemo implements UNITS
{
    ...
    public final JPanel buildGUI() throws PropertyException
    {
        ...
        this.imbProperties = OTSIMBConnector.standardIMBProperties(0);
        ...
        startButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(final ActionEvent e)
            {
                ...
                for (Component c : IMBSuperDemo.this.simulationSelection.getComponents())
                {
                ...
                try
                {
                    System.out.println("Active properties: " + IMBSuperDemo.this.activeProperties);
...
class CleverRadioButton extends JRadioButton
{
    ...
    private final WrappableIMBAnimation imbAnimation;
