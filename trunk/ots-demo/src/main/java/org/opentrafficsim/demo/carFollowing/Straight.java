...
class StraightModel implements OTSModelInterface, UNITS
{
     ...
     */
    StraightModel(final ArrayList<AbstractProperty<?>> properties, final GTUColorer gtuColorer)
    {
    ...
    protected final void createBlock()
    {
        ...
        try
        {
            ...
            this.block = new LaneBasedIndividualGTU("999999", this.gtuType, new Length(4, METER), new Length(1.8, METER),
                    Speed.ZERO, this.simulator, DefaultCarAnimation.class, this.gtuColorer, this.network);
            ...
            this.block.init(strategicalPlanner, initialPositions, Speed.ZERO);
        }
