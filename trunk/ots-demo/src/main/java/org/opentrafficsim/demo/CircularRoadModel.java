    ...
    public void makeInputParameterMap()
    {
        try
        {
            ...
            genericMap.add(new InputParameterDouble("carProbability", "Car probability",
                    "Probability that the next generated GTU is a passenger car", 0.8, 0.0, 1.0, true, true, "%.00f", 2.0));
            genericMap.add(new InputParameterDouble("densityMean", "Mean density (veh / km)",
                    "mean density of the vehicles (vehicles per kilometer)", 30.0, 5.0, 45.0, true, true, "%.0f", 3.0));
