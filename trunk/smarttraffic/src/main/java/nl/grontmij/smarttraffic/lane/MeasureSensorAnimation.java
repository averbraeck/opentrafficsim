 ...
 */
public class MeasureSensorAnimation extends OTSRenderable2D
{
     ...
     */
    public MeasureSensorAnimation(final MeasureSensor sensor, final OTSSimulatorInterface simulator) throws NamingException,
        RemoteException
    {
    ...
    {
        return "MeasureSensorAnimation [getSource()=" + this.getSource() + "]";
    }
