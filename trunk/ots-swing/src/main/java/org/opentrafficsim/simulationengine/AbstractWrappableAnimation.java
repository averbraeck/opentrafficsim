 ...
 * <p>
 * $LastChangedDate: 2018-10-23 00:42:09 +0200 (Tue, 23 Oct 2018) $, @version $Revision: 4711 $, by $Author: wjschakel $,
...
public abstract class AbstractWrappableAnimation implements WrappableAnimation, Serializable
{
    ...
    /** The model. */
    private OTSModelInterface<OTSSimulatorInterface> model;
     ...
     * @param otsModel OTSModelInterface<OTSSimulatorInterface>; the simulation model
    ...
    {
        SimpleAnimator animator = (SimpleAnimator) otsModel.getSimulator();
        animator.initialize(startTime, warmupPeriod, runLength, otsModel);
        return animator;
    }
    ...
    {
        SimpleAnimator animator = (SimpleAnimator) otsModel.getSimulator();
        animator.initialize(startTime, warmupPeriod, runLength, otsModel, replicationNumber);
        return animator;
    }
            ...
            throws SimRuntimeException, NamingException, OTSSimulationException, PropertyException
    {
        ...
        // Frame
        SimulatorFrame frame = new SimulatorFrame(getShortName(), this.panel);
        if (rect != null)
        {
     ...
     * <p>
     * @version $Revision: 4711 $, $LastChangedDate: 2018-10-23 00:42:09 +0200 (Tue, 23 Oct 2018) $, by $Author: wjschakel $,
