	...
	{
		echo "\n";
		indent (5);	echo "<div class=\"form-group row\">\n";
		indent (6); echo "<label for=\"$id\" class=\"col-sm-3 form-control-label\">$caption</label>\n";
		indent (6); echo "<div class=\"col-sm-3\">\n";
		indent (7); echo "<input type=\"text\" class=\"form-control form-control-sm\" id=\"$id\" placeholder=\"$caption\">\n";
		indent (6); echo "</div>\n";
		...
		if ("Length" == $unit)
		{
			...
			indent (8); echo "<option>dam</option>\n";
			indent (8); echo "<option>hm</option>\n";
			indent (8); echo "<option>km</option>\n";
