/*
 * @(#) PanLeftAction.java Oct 29, 2003 Copyright (c) 2002-2005 Delft University
...
public class PanLeftAction extends AbstractAction
{
    ...
    public PanLeftAction(final GridPanel target)
    {
        super("PanLeft");
        this.target = target;
        this.putValue(Action.SMALL_ICON, new ImageIcon(URLResource.getResource("/toolbarButtonGraphics/navigation/Back16.gif")));
