 ...
 */
public class LaneBasedTemplateGTU extends AbstractLaneBasedTemplateGTU
{
    /** */
     ...
     */
    public LaneBasedTemplateGTU(final String id, final LaneBasedTemplateGTUType templateGtuType,
    ...
    public static class LaneBasedTemplateCarBuilder
    {
         ...
         * @throws OTSGeometryException when the initial path is wrong
         */
        public final LaneBasedTemplateGTU build() throws NamingException, NetworkException, SimRuntimeException,
            GTUException, InstantiationException, IllegalAccessException, OTSGeometryException
        {
            ...
            return new LaneBasedTemplateGTU(this.id, this.templateGtuType, this.initialLongitudinalPositions,
