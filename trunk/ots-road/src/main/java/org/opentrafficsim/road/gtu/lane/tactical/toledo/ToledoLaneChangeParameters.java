...
public final class ToledoLaneChangeParameters
{
    ...
    /** */
    public static final ParameterTypeDouble BETA1 = new ParameterTypeDouble("Beta1", "Factor on 1 lane change dummy variable.",
            -2.269);

    /** */
    public static final ParameterTypeDouble BETA2 = new ParameterTypeDouble("Beta2", "Factor on 2 lane change dummy variable.",
            -4.466);

    /** */
    public static final ParameterTypeDouble BETA3 = new ParameterTypeDouble("Beta3", "Factor on 3 lane change dummy variable.",
            -7.265);
    ...
    public static final ParameterTypeDouble C_FWD_ACC = new ParameterTypeDouble("C_fwd_acc",
            "Constant forward gap acceleration.", 0.385, ConstraintInterface.POSITIVE);
    ...
    public static final ParameterTypeDouble C_BCK_ACC = new ParameterTypeDouble("C_bck_acc",
            "Constant backward gap acceleration.", -0.596, ConstraintInterface.NEGATIVE);
