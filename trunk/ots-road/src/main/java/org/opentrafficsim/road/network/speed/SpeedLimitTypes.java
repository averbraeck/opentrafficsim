...
public class SpeedLimitTypes
{
    ...
    public static final SpeedLimitTypeSpeedLegal MAX_LEGAL_VEHICLE_SPEED = new SpeedLimitTypeSpeedLegal(
        "Maximum legal vehicle speed");
    ...
    public static final SpeedLimitType<SpeedInfoCurvature> CURVATURE = new SpeedLimitType<SpeedInfoCurvature>("Curvature",
        SpeedInfoCurvature.class);
