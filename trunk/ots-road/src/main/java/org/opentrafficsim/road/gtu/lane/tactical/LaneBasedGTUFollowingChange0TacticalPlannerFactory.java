    ...
    LaneBasedTacticalPlannerFactory<LaneBasedGTUFollowingChange0TacticalPlanner>
{
     ...
     */
    public LaneBasedGTUFollowingChange0TacticalPlannerFactory(final GTUFollowingModelOld carFollowingModel)
    {
    ...
    /** {@inheritDoc} */
    @Override
    public final LaneBasedGTUFollowingChange0TacticalPlanner create(final LaneBasedGTU gtu) throws GTUException
    {
        return new LaneBasedGTUFollowingChange0TacticalPlanner(this.carFollowingModel, gtu);
    }
