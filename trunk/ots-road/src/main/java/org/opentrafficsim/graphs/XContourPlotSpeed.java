 ...
 */
public class XContourPlotSpeed extends XAbstractContourPlot<Speed>
{
     ...
     */
    public XContourPlotSpeed(final String caption, final OTSSimulatorInterface simulator, final XContourDataPool dataPool)
    {
