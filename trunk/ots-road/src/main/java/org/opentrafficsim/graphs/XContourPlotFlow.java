 ...
 */
public class XContourPlotFlow extends XAbstractContourPlot<Frequency>
{
     ...
     */
    public XContourPlotFlow(final String caption, final OTSSimulatorInterface simulator, final XContourDataPool dataPool)
    {
