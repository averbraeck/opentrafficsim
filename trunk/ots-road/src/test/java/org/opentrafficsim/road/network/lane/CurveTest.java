...
public class CurveTest
{
    ...
    public void curveTest() throws OTSGeometryException, SimRuntimeException, NamingException, NetworkException, GTUException
    {
        ...
        Lane[] straight1 =
                LaneFactory.makeMultiLane("straight1", origin, curveStart, null, laneCount, laneType, speedLimit, simulator);
        Lane[] straight2 =
                LaneFactory.makeMultiLane("straight2", curveEnd, destination, null, laneCount, laneType, speedLimit, simulator);
