...
import org.opentrafficsim.road.network.factory.rti.communication.RTICars;
 ...
 */
public class TestOpenDriveParserSV extends AbstractOTSSwingApplication
{
    /** */
                ...
                throws SimRuntimeException
        {
            ...
            for (int i = 0; i < 52; i++)
            {
                ...
                if (isEnoughSpace)
                {
                    try
                    {
                        RTICars car = new RTICars(String.valueOf(i), carType, carLength, widthDist.draw(), maxSpeedDist.draw(),
