...
public class FloatVectorDenseTest
{
    ...
    public final void toStringAbsTest()
    {
        ...
        String result = fv.toString(true);
    ...
    public final void toStringMutableAbsTest()
    {
        ...
        TemperatureUnit tempUnit = TemperatureUnit.KELVIN;
        float[] value = data(3, 38.0f);
        MutableFloatVector.Abs.Dense<TemperatureUnit> fv = new MutableFloatVector.Abs.Dense<TemperatureUnit>(value, tempUnit);
        String result = fv.toString(true);
        assertTrue("toString result contains \" Abs \"", result.contains(" Abs "));
        assertTrue("toString result contains \"[K]\"", result.contains("[K]"));
    ...
    public final void basicsAbsTest()
    {
        try
        {
            ...
            MutableFloatVector.Abs.Dense<TemperatureUnit> mfv = new MutableFloatVector.Abs.Dense<TemperatureUnit>(value, tempUnit);
            ...
            checkContentsAndType(mfv, value, 0.001f, tempUnit, true);
            FloatVector.Abs.Dense<TemperatureUnit> temperature2FV = new FloatVector.Abs.Dense<TemperatureUnit>(temperatureFV.getVectorSI(), TemperatureUnit.KELVIN);
    ...
    public final void scaleAbsTest()
    {
        try
        {
            ...
            FloatVector.Abs.Dense<TemperatureUnit> left = new FloatVector.Abs.Dense<TemperatureUnit>(leftIn, TemperatureUnit.KELVIN);
    ...
    public final void toStringMutableRelTest()
    {
        ...
        TemperatureUnit tempUnit = TemperatureUnit.KELVIN;
        float[] value = data(3, 38.0f);
        MutableFloatVector.Rel.Dense<TemperatureUnit> fv = new MutableFloatVector.Rel.Dense<TemperatureUnit>(value, tempUnit);
        String result = fv.toString(true);
        assertTrue("toString result contains \" Rel \"", result.contains(" Rel "));
        assertTrue("toString result contains \"[K]\"", result.contains("[K]"));
        assertTrue("toString result starts with \"Immutable \"", result.startsWith("Mutable"));
    ...
    public final void basicsRelTest()
    {
        try
        {
            ...
            MutableFloatVector.Rel.Dense<TemperatureUnit> mfv = new MutableFloatVector.Rel.Dense<TemperatureUnit>(value, tempUnit);
            ...
            mfv.set(0, temperatureFV.get(0));
            checkContentsAndType(mfv, value, 0.001f, tempUnit, false);
            FloatVector.Rel.Dense<TemperatureUnit> temperature2FV = new FloatVector.Rel.Dense<TemperatureUnit>(temperatureFV.getVectorSI(), TemperatureUnit.KELVIN);
            assertTrue("temperature2FV should be equal to temperatureFV", temperature2FV.equals(temperatureFV));
    ...
    public final void scaleRelTest()
    {
        ...
        {
            float[] leftIn = data(3, -12.34f);
            FloatVector.Rel.Dense<TemperatureUnit> left = new FloatVector.Rel.Dense<TemperatureUnit>(leftIn, TemperatureUnit.KELVIN);
            float[] right = data(3, -4.321f);
