 ...
 * <p>
 * This file was generated by the OpenTrafficSim value test classes generator, 09 jan, 2015
 * <p>
...
public class DoubleMatrixSparseTest
{
    ...
    public final void toStringMutableAbsTest()
    {
        try
        {
            TemperatureUnit tempUnit = TemperatureUnit.KELVIN;
            double[][] value = data(3, 5, false, 38.0);
            MutableDoubleMatrix.Abs.Sparse<TemperatureUnit> dm = new MutableDoubleMatrix.Abs.Sparse<TemperatureUnit>(value, tempUnit);
            String result = dm.toString(true);
            assertTrue("toString result contains \" Abs \"", result.contains(" Abs "));
            assertTrue("toString result contains \"[K]\"", result.contains("[K]"));
    ...
    public final void basicsAbsTest()
    {
        try
        {
            ...
            double[][] value = data(3, 5, false, 38.0);
            DoubleMatrix.Abs.Sparse<TemperatureUnit> temperatureDM = new DoubleMatrix.Abs.Sparse<TemperatureUnit>(value, tempUnit);
            ...
            MutableDoubleMatrix.Abs.Sparse<TemperatureUnit> mdm = new MutableDoubleMatrix.Abs.Sparse<TemperatureUnit>(value, tempUnit);
            ...
            checkContentsAndType(mdm, value, 0.001, tempUnit, true);
            DoubleMatrix.Abs.Sparse<TemperatureUnit> temperature2DM = new DoubleMatrix.Abs.Sparse<TemperatureUnit>(temperatureDM.getMatrixSI(), TemperatureUnit.KELVIN);
    ...
    public final void determinantAbsTest()
    {
        try
        {
            ...
            DoubleMatrix.Abs.Sparse<TemperatureUnit> matrix = new DoubleMatrix.Abs.Sparse<TemperatureUnit>(values, TemperatureUnit.KELVIN);
    ...
    public final void scaleAbsTest()
    {
        try
        {
            ...
            DoubleMatrix.Abs.Sparse<TemperatureUnit> left = new DoubleMatrix.Abs.Sparse<TemperatureUnit>(leftIn, TemperatureUnit.KELVIN);
    ...
    public final void toStringMutableRelTest()
    {
        try
        {
            TemperatureUnit tempUnit = TemperatureUnit.KELVIN;
            double[][] value = data(3, 5, false, 38.0);
            MutableDoubleMatrix.Rel.Sparse<TemperatureUnit> dm = new MutableDoubleMatrix.Rel.Sparse<TemperatureUnit>(value, tempUnit);
            String result = dm.toString(true);
            assertTrue("toString result contains \" Rel \"", result.contains(" Rel "));
            assertTrue("toString result contains \"[K]\"", result.contains("[K]"));
            assertTrue("toString result starts with \"Immutable \"", result.startsWith("Mutable"));
    ...
    public final void basicsRelTest()
    {
        try
        {
            TemperatureUnit tempUnit = TemperatureUnit.DEGREE_CELSIUS;
            double[][] value = data(3, 5, false, 38.0);
            DoubleMatrix.Rel.Sparse<TemperatureUnit> temperatureDM = new DoubleMatrix.Rel.Sparse<TemperatureUnit>(value, tempUnit);
            ...
            MutableDoubleMatrix.Rel.Sparse<TemperatureUnit> mdm = new MutableDoubleMatrix.Rel.Sparse<TemperatureUnit>(value, tempUnit);
            ...
            mdm.set(0, 0, temperatureDM.get(0, 0));
            checkContentsAndType(mdm, value, 0.001, tempUnit, false);
            DoubleMatrix.Rel.Sparse<TemperatureUnit> temperature2DM = new DoubleMatrix.Rel.Sparse<TemperatureUnit>(temperatureDM.getMatrixSI(), TemperatureUnit.KELVIN);
            assertTrue("temperature2DM should be equal to temperatureDM", temperature2DM.equals(temperatureDM));
    ...
    public final void determinantRelTest()
    {
        ...
        {
            double[][] values = {{1, 2, 3 }, {3, 5, 7 }, {5, 10, 0} };
            DoubleMatrix.Rel.Sparse<TemperatureUnit> matrix = new DoubleMatrix.Rel.Sparse<TemperatureUnit>(values, TemperatureUnit.KELVIN);
            assertEquals("Determinant should be 15", 15, matrix.det(), 0.001);
        }
        catch (ValueException ve)
        {
    ...
    public final void scaleRelTest()
    {
        ...
        {
            double[][] leftIn = data(3, 5, false, -12.34);
            DoubleMatrix.Rel.Sparse<TemperatureUnit> left = new DoubleMatrix.Rel.Sparse<TemperatureUnit>(leftIn, TemperatureUnit.KELVIN);
            double[][] right = data(3, 5, false, -4.321);
