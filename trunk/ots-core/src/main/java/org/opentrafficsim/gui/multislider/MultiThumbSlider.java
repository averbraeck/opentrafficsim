 ...
 *
 * $Date: 2014-12-19 22:05:11 -0600 (Fri, 19 Dec 2014) $
 *
 ...
 * </ul>
 * <P>
 * Because thumbs can be abstractly inserted, this values each thumb represents should be tween-able. That is, if there
...
public class MultiThumbSlider<T> extends JComponent
{
    ...
    /** Whether or not thumbs can cross over other thumbs. */
    public static final String CROSSOVER_PROPERTY = MultiThumbSlider.class.getName() + ".crossover";
     ...
     * @param ignoreIfUnfocused if this component doesn't have focus and this is <code>true</code>, then this returns -1.
     *            If this is <code>false</code> then this returns the internal value used to store the selected index,
     *            but the user may not realize this thumb is "selected".
    ...
    public boolean isCrossoverAllowed()
    {
        Boolean b = (Boolean) getClientProperty(CROSSOVER_PROPERTY);
        if (b == null)
            return true;
        return b;
    }

    public void setCrossoverAllowed(boolean b)
    {
        putClientProperty(CROSSOVER_PROPERTY, b);
    }
}
