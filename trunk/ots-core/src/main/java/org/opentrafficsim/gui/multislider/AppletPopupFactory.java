 ...
 * <p>
 * Many browsers consistently render popups in the wrong location: they take the (x, y) of the applet but display the
 * popup menu relative to the browser window instead of the applet -- so it is displaced up and to the left.
 * <p>
...
public class AppletPopupFactory extends PopupFactory
{
    ...
    static class AppletPopup extends Popup
    {
        ...
        public AppletPopup(JApplet applet, Component owner, JComponent component, int x, int y)
        {
            ...
            /*
             * For some bizarre reason: the LineBorder doesn't show up like it should. So we extract it and let the
             * blocking pane paint it instead.
             */
            ...
            /**
             * Extract the background color to paint under the popup. This is custom-designed to work with Mac's and the
             * AquaComboBoxUI.
             */
    ...
    /**
     * @param oldFactory we defer to this factory when we don't have to use the fake popup model.
     */
