 ...
 *
 * $Date: 2014-12-19 22:22:04 -0600 (Fri, 19 Dec 2014) $
 *
...
public abstract class MultiThumbSliderUI<T> extends ComponentUI implements MouseListener, MouseMotionListener
{
    ...
    class State
    {
        ...
        {
            if (!slider.isCrossoverAllowed())
            {
                // verify that this is a kosher move to make:
    ...
    KeyListener keyListener = new KeyListener()
    {
        public void keyPressed(KeyEvent e)
        {
            ...
            else if (code == KeyEvent.VK_DOWN && orientation == MultiThumbSlider.HORIZONTAL && i != -1)
            {
                // popup up!
                int x =
                        slider.isInverted() ? (int) (trackRect.x + trackRect.width
                                * (1 - slider.getThumbPositions()[i])) : (int) (trackRect.x + trackRect.width
