 ...
 */
public class TestXMLStringParser extends DSOLApplication
{
    /** */
     ...
     * @param panel p
     */
    public TestXMLStringParser(final String title,
    ...
    public static void main(final String[] args) throws RemoteException, SimRuntimeException, NamingException
    {
        ...
        new TestXMLStringParser("TestXMLStringParser", panel);
    }
