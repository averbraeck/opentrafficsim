...
public interface LaneBasedGTU<ID> extends GTU<ID>
{
     ...
     * When no vehicle is found within the given maxDistance, maxDistance is returned. The search will extend into
     * successive lanes if the maxDistance is larger than the length of the lane. When Lanes (or underlying
