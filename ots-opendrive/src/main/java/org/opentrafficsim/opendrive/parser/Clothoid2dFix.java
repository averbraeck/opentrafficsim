...
/**
 * {@link Clothoid2d} extension that fixes the second constructor.
 * <p>
 ...
 */
public class Clothoid2dFix extends Clothoid2d
{
     ...
     */
    public Clothoid2dFix(final DirectedPoint2d startPoint, final DirectedPoint2d endPoint)
    {
        super(startPoint, endPoint);
        // super.getPoint(double, double) needs assureShift() but doesn't, trigger it via toPolyLine
        toPolyLine(new Flattener2d.NumSegments(1));
    }
     ...
     */
    public Clothoid2dFix(final DirectedPoint2d startPoint, final double a, final double startCurvature,
            final double endCurvature)
    {
        this(startPoint, getEndPoint(startPoint, a, startCurvature, endCurvature));
    }
            ...
            final double endCurvature)
    {
        ...
        double x1;
        double y1;
        if (dCurvatureAbs < EPS)
        {
            if (Math.abs(startCurvature) < EPS)
            {
        ...
        return new DirectedPoint2d(x1, y1, phi1);
    }

    // Copies from Clothoid2d.java
            ...
            final double endCurvature)
    {
        ...
        return new Clothoid2dFix(startPoint, a, startCurvature, endCurvature);
    }

    /**
     * Copy.
     */
    private final class Fresnel
    {
        ...
        /**
         * Approximate the Fresnel integral. The method used is based on Cody (1968). This method applies rational approximation
         * to approximate the clothoid. For clothoid rotation beyond 1.6 rad, this occurs in polar form. The polar form is
         * robust for arbitrary large numbers, unlike polynomial expansion, and will at a large threshold converge to (0.5,
         * 0.5). There are 5 regions with different fitted values for the rational approximations, in Cartesian or polar
         * form.<br>
         * <br>
         * W.J. Cody (1968) Chebyshev approximations for the Fresnel integrals. Mathematics of Computation, Vol. 22, Issue 102,
         * pp. 450–453.
