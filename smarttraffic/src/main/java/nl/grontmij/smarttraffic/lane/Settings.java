...
public final class Settings
{
    ...
    public static Integer getInt(final OTSDEVSSimulatorInterface simulator, final String name)
    {
        test(simulator, name);
        String s = PROPS.get(simulator.hashCode()).getProperty(name);
    ...
    public static String[] getStringArray(final OTSDEVSSimulatorInterface simulator, final String name)
    {
        test(simulator, name);
