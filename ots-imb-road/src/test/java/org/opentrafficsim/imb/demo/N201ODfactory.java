...
public class N201ODfactory
{
     ...
     */
    public static Query getQuery(final OTSNetwork network, final Sampler sampler, final FilterDataSet metaDataSet)
    {
        // String[] southBound = new String[] { "L1a", "L2a", "L3a4a", "L5a", "L6a", "L7a", "L8a9a", "L10a11a", "L12a",
        // "L13a14a", "L15a16a", "L17a", "L18a19a", "L20a21a", "L22a", "L23a24a", "L25a", "L26a", "L27a", "L28a29a", "L30a",
        // "L31a", "L32a", "L33a", "L34a", "L35a", "L36a", "L37a", "L38a", "L39a", "L40a", "L41a", "L42a", "L43a", "L44a",
        // "L45a", "L46a", "L47a48a", "L49a" };
