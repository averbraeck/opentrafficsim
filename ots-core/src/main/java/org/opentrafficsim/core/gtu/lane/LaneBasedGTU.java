...
public interface LaneBasedGTU<ID> extends GTU<ID>
{
    ...
    /**
     * Register the lane with a GTU, at the start of the lane. The reference point will be registered at the time and
     * relative position of the last evaluation of the GTU to keep calculations consistent.
    ...
    /**
     * Return the longitudinal position of a point relative to this GTU, relative to the center line of the Lane at the
     ...
     * <code>new DoubleScalar.Rel&lt;LengthUnit&gt;(Double.MAX_VALUE, LengthUnit.METER)</code> is returned. The search
     * will extend into successive lanes if the maxDistance is larger than the length of the lane.<br>
     * <b>Note:</b> Headway is the net headway and calculated on a front-to-back basis.
