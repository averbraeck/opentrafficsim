 ...
 */
public class XContourPlotSpeed<G extends GtuDataInterface> extends XAbstractContourPlot<Speed, G>
{
     ...
     */
    public XContourPlotSpeed(final String caption, final OTSSimulatorInterface simulator, final XContourDataPool<G> dataPool)
    {
