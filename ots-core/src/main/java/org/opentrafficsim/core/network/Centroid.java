...
public class Centroid extends OtsNode
{
    ...
    {
        Throw.when(!link.isOfType(this.getNetwork().getLinkType(LinkType.DEFAULTS.CONNECTOR)), OtsRuntimeException.class,
                "Centroids can only be connected by connector links");
        super.addLink(link);
    }
