 ...
 * overtake. Similarly, on secondary roads it is sometimes forbidden to overtake, except when the GTU in front is a tractor. The
 * models in this package should allow to code for these situations and indicate whether changing lane to the left or right is
 * allowed, given the circumstances.
 * <p>
