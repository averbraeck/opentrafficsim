...
public final class LaneFactory
{
    ...
    private static Lane makeLane(final CrossSectionLink<?, ?> link, final LaneType<String> laneType,
            final DoubleScalar.Rel<LengthUnit> latPosAtStart, Rel<LengthUnit> latPosAtEnd,
            final DoubleScalar.Rel<LengthUnit> width, final OTSDEVSSimulatorInterface simulator)
            ...
            final OTSDEVSSimulatorInterface simulator) throws RemoteException, NamingException, NetworkException
    {
        ...
        return makeLane(link, laneType, latPos, latPos, width, simulator);
    }
    ...
    public static Lane[] makeMultiLane(final String name, final NodeGeotools.STR from, final NodeGeotools.STR to,
            final Coordinate[] intermediateCoordinates, final int laneCount, int laneOffsetAtStart,
            int laneOffsetAtEnd, final LaneType<String> laneType, final OTSDEVSSimulatorInterface simulator)
            throws RemoteException, NamingException, NetworkException
    {
        ...
        for (int laneIndex = 0; laneIndex < laneCount; laneIndex++)
        {
            ...
            result[laneIndex] = makeLane(link, laneType, latPosAtStart, latPosAtEnd, width, simulator);
        }
    ...
    public static Lane[] makeMultiLane(final String name, final NodeGeotools.STR from, final NodeGeotools.STR to,
            ...
            final OTSDEVSSimulatorInterface simulator) throws RemoteException, NamingException, NetworkException
    {
        return makeMultiLane(name, from, to, intermediateCoordinates, laneCount, 0, 0, laneType, simulator);
    }
