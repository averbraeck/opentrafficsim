        ...
        for (List<Sensor> sensorList : this.sensors.values())
        {
            for (Sensor sensor : sensorList)
            {
                for (RelativePosition relativePosition : gtu.getRelativePositions().values())
                {
                    ...
                    {
                        if (referenceStartSI + relativePosition.getDx().getSI() <= sensor.getLongitudinalPositionSI()
                                ...
                                .getLongitudinalPositionSI())
                        {
                            ...
                            gtu.getSimulator().scheduleEventAbs(new DoubleScalar.Abs<TimeUnit>(t, TimeUnit.SECOND), this,
