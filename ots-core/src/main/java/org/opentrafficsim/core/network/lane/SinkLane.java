 ...
 * <p>
 * $LastChangedDate$, @version $Revision$, by $Author$, initial versionJan 30, 2015 <br>
...
public class SinkLane extends Lane
{
    ...
    private static class SinkSensor extends AbstractSensor
    {
        ...
        {
            super(lane, new DoubleScalar.Rel<LengthUnit>(0.0, LengthUnit.METER), RelativePosition.FRONT);
        }
