...
public final class Calc
{
     ...
     *         the indicated speed
     */
    public static DoubleScalar.Rel<LengthUnit> speedSquaredDividedByDoubleAcceleration(
            final DoubleScalar<SpeedUnit> speed, final DoubleScalar.Abs<AccelerationUnit> acceleration)
    {
