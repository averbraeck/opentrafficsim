...
public abstract class DoubleScalar<U extends Unit<U>> extends Scalar<U>
{
    ...
    {
        return toString(displayUnit, false);
    }

    /**
     * Print this DoubleScalar with optional type information.
     * @param verbose boolean; if true; include type info; if false; do not include type info
     * @return String; printable string with the scalar contents
     */
    public final String toString(final boolean verbose)
    {
        return toString(getUnit(), verbose);
    }
     ...
     * @return String; printable string with the scalar contents
     */
    public final String toString(final U displayUnit, final boolean verbose)
    {
