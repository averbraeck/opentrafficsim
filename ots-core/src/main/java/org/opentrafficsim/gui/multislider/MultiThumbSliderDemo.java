...
public class MultiThumbSliderDemo extends BricApplet {
	...
	public MultiThumbSliderDemo() {
		...
		MultiThumbSlider<Character> slider = new MultiThumbSlider<Character>(MultiThumbSlider.HORIZONTAL, new float[] {0f, .5f, .75f, 1f}, new Character[] {'A', 'B', 'C', 'D'});
		...
		c.gridx = 0; c.gridy = 1;
		slider = new MultiThumbSlider<Character>(MultiThumbSlider.VERTICAL, new float[] {0f, .75f}, new Character[] {'X', 'Y'});
		slider.setPaintTicks(true);
		slider.putClientProperty("MultiThumbSlider.indicateComponent", "false");
		getContentPane().add(slider,c);

		c.gridx = 2; c.gridy = 1;
		slider = new MultiThumbSlider<Character>(MultiThumbSlider.VERTICAL, new float[] {0f, .4f, .75f}, new Character[] {'X', 'Y', 'Z'});
		slider.setInverted(true);
		slider.putClientProperty("MultiThumbSlider.indicateComponent", "false");
		getContentPane().add(slider,c);

		c.gridx = 1; c.gridy = 2;
		slider = new MultiThumbSlider<Character>(MultiThumbSlider.HORIZONTAL, new float[] {0f, .4f}, new Character[] {'X', 'Y'});
		slider.setInverted(true);
		getContentPane().add(slider,c);
