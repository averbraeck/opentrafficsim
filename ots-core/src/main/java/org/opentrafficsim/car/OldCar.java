...
public class OldCar
{
    ...
    private final GTUFollowingModel carFollowingModel;
     ...
     */
    public OldCar(final int id, final OTSDEVSSimulatorInterface simulator, final GTUFollowingModel carFollowingModel,
     ...
     */
    public final void setState(final GTUFollowingModelResult cfmr)
    {
     ...
     * @throws RemoteException
     */
    public final DoubleScalar.Rel<LengthUnit> headway(final OldCar otherCar) throws RemoteException
    {
     ...
     */
    public final GTUFollowingModel getCarFollowingModel()
    {
