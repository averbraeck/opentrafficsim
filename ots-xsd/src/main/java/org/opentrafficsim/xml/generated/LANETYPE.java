...
@XmlType(name = "", propOrder = {"compatibility"})
...
public class LANETYPE
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-03-16T07:08:16+01:00", comments = "JAXB RI v2.3.0")
    protected List<LANETYPE.COMPATIBILITY> compatibility;
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link LANETYPE.COMPATIBILITY }
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-03-16T07:08:16+01:00", comments = "JAXB RI v2.3.0")
    public List<LANETYPE.COMPATIBILITY> getCOMPATIBILITY()
    {
        if (compatibility == null)
        {
            compatibility = new ArrayList<LANETYPE.COMPATIBILITY>();
        }
