...
@SuppressWarnings("all") public class RandomStreams
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the randomStream property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the randomStream property.
     */
    public List<RandomStream> getRandomStream() {
        if (randomStream == null) {
            randomStream = new ArrayList<>();
        }
