 ...
 */
public class TestOpenDriveParserNoRTI extends OTSSimulationApplication<OTSModelInterface>
{
    /** */
     ...
     */
    public TestOpenDriveParserNoRTI(final OTSModelInterface model, final OTSAnimationPanel animationPanel)
    ...
    public static void main(final String[] args) throws SimRuntimeException
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    OTSAnimator simulator = new OTSAnimator("TestOpenDriveParserNoRTI");
