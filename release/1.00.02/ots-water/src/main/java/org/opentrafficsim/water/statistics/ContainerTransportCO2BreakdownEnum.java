 ...
 * @version SVN $Revision: 93 $ $Author: averbraeck $
 * $Date: 2014-03-07 07:46:54 +0100 (Fri, 07 Mar 2014) $
 **/
@SuppressWarnings("javadoc")
public enum ContainerTransportCO2BreakdownEnum {

    TRANSPORT_SHIPPER("voor/natransport",
            "CO2-productie voor voor/natransport tussen verlader en inlandterminal met de truck"),
    ...
    RTM_TERMINAL("terminal Rtm",
            "CO2-productie voor het laden/lossen van de container aan de kade van de terminal in Rtm"),
