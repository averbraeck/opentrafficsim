 ...
 * @version SVN $Revision: 97 $ $Author: averbraeck $
 * $Date: 2014-03-11 14:52:52 +0100 (Tue, 11 Mar 2014) $
 **/
...
public enum ContainerTransportFeeBreakdownEnum {
    ...
    RTM_TERMINAL("move Rtm",
            "tarief voor het laden/lossen van de container aan de kade van de terminal in Rtm (1 move)"),
