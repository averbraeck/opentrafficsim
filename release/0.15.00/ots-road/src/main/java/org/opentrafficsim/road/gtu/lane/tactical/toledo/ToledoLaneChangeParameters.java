...
public final class ToledoLaneChangeParameters
{
    ...
    /** */
    public static final ParameterTypeDouble BETA_DP =
            new ParameterTypeDouble("BETA_DP", "Factor on target gap for desired position.", 0.604, UNITINTERVAL);

    /** */
    public static final ParameterTypeDouble C_FWD_ACC =
            new ParameterTypeDouble("C_fwd_acc", "Constant forward gap acceleration.", 0.385, POSITIVE);
    ...
    public static final ParameterTypeDouble C_BCK_ACC =
            new ParameterTypeDouble("C_bck_acc", "Constant backward gap acceleration.", -0.596, NEGATIVE);
