...
class RoadLayoutTag implements Serializable
{
     ...
     */
    @SuppressWarnings("checkstyle:needbraces")
    static RoadLayoutTag parseRoadType(final Node node, final XmlNetworkLaneParser parser) throws SAXException, NetworkException
    {
        ...
        if (width != null)
            roadLayoutTag.defaultLaneWidth = LengthUnits.parseLength(width.getNodeValue());
