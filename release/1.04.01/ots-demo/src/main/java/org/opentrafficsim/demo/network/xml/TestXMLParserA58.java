...
import org.opentrafficsim.demo.network.xml.TestXMLParserA58.TestXMLModelA58;
 ...
 */
public class TestXMLParserA58 extends OTSSimulationApplication<TestXMLModelA58>
{
    /** */
     ...
     */
    public TestXMLParserA58(final TestXMLModelA58 model, final OTSAnimationPanel animationPanel) throws OTSDrawingException
    {
    ...
    public static void main(final String[] args) throws SimRuntimeException
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    OTSAnimator simulator = new OTSAnimator("TestXMLParserA58");
                    TestXMLModelA58 xmlModel = new TestXMLModelA58(simulator);
     ...
     */
    static class TestXMLModelA58 extends AbstractOTSModel
    {
        /** */
         ...
         */
        TestXMLModelA58(final OTSSimulatorInterface simulator)
        {
            super(simulator);
        }
        ...
        public final String toString()
        {
            return "TestXMLModelA58 [simulator=" + this.simulator + "]";
        }
