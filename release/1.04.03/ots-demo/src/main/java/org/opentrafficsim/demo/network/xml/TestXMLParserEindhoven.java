...
import org.opentrafficsim.demo.network.xml.TestXMLParserEindhoven.TestXMLModelEindhoven;
 ...
 */
public class TestXMLParserEindhoven extends OTSSimulationApplication<TestXMLModelEindhoven>
{
    /** */
     ...
     */
    public TestXMLParserEindhoven(final TestXMLModelEindhoven model, final OTSAnimationPanel animationPanel)
    ...
    public static void main(final String[] args) throws SimRuntimeException
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    OTSAnimator simulator = new OTSAnimator("TestXMLParserEindhoven");
                    TestXMLModelEindhoven xmlModel = new TestXMLModelEindhoven(simulator);
                    ...
                    new TestXMLParserEindhoven(xmlModel, animationPanel);
     ...
     */
    static class TestXMLModelEindhoven extends AbstractOTSModel
    {
        /** */
         ...
         */
        TestXMLModelEindhoven(final OTSSimulatorInterface simulator)
        {
            super(simulator);
        }
        ...
        {
            URL xmlURL = URLResource.getResource("/xml/Eindhoven.xml");
            ...
            URL gisURL = URLResource.getResource("/xml/A58/map.xml");
        ...
        public final String toString()
        {
            return "TestXMLModelEindhoven [simulator=" + this.simulator + "]";
        }
