...
class GeneratorTag implements Serializable
{
    ...
    static void parseGenerator(final Node node, final XmlNetworkLaneParserOld parser, final LinkTag linkTag)
     ...
     * @throws GTUException when construction of the Strategical Planner failed
     */
    static void makeGenerator(final GeneratorTag generatorTag, final XmlNetworkLaneParserOld parser, final LinkTag linkTag,
            final OTSSimulatorInterface simulator) throws SimRuntimeException, NetworkException, GTUException
    {
