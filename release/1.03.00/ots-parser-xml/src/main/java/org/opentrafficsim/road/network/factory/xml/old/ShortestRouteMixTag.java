...
class ShortestRouteMixTag implements Serializable
{
    ...
    static void parseShortestRouteMix(final NodeList nodeList, final XmlNetworkLaneParserOld parser)
     ...
     */
    @SuppressWarnings("checkstyle:needbraces")
    private static void parseRouteMixRouteTag(final Node shortestRouteNode, final XmlNetworkLaneParserOld parser,
