 ...
 */
public class LMRSTests extends OTSSimulationApplication<OTSModelInterface>
{
    /** */
     ...
     */
    public LMRSTests(final OTSModelInterface model, final OTSAnimationPanel animationPanel) throws OTSDrawingException
    {
        ...
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    new LMRSTests(xmlModel, animationPanel);
                }
