 ...
 */
public class TestExampleNew extends OTSSimulationApplication<OTSModelInterface>
{
    /** */
     ...
     */
    public TestExampleNew(final OTSModelInterface model, final OTSAnimationPanel animationPanel) throws OTSDrawingException
    {
        ...
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    new TestExampleNew(xmlModel, animationPanel);
                }
    ...
    static class TestXMLModel extends AbstractOTSModel
    {
        ...
        {
            URL url = URLResource.getResource("/example.xml");
