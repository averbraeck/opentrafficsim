 ...
 */
public class TestXMLParserAimsunNew extends OTSSimulationApplication<OTSModelInterface>
{
    /** */
     ...
     */
    public TestXMLParserAimsunNew(final OTSModelInterface model, final OTSAnimationPanel animationPanel) throws OTSDrawingException
    {
        ...
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    new TestXMLParserAimsunNew(xmlModel, animationPanel);
                }
