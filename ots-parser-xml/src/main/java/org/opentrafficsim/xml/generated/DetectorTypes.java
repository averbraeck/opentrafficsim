...
public class DetectorTypes implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the detectorType property.
     * 
     * <p>
    ...
    public List<DetectorType> getDetectorType() {
        if (detectorType == null) {
            detectorType = new ArrayList<DetectorType>();
        }
