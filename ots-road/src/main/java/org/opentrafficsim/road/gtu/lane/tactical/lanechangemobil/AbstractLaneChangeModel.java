 ...
 */
public abstract class AbstractLaneChangeModel implements LaneChangeModel, Serializable
{
    /** */
        ...
        try
        {
            ...
            if (null == preferredA)
            {
                ...
                else
                {
                    ...
                    if (DoubleScalar.plus(nonPreferredA, nonPreferredLaneRouteIncentive).gt(
                        straightA.plus(extraThreshold)))
                    {
