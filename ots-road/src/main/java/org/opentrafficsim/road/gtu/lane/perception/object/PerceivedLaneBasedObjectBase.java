...
public class PerceivedLaneBasedObjectBase extends PerceivedObjectBase implements PerceivedLaneBasedObject
{
     ...
     * @param lane lane
     */
    public PerceivedLaneBasedObjectBase(final String id, final ObjectType objectType, final Length length,
    ...
    public boolean equals(final Object obj)
    {
        ...
        PerceivedLaneBasedObjectBase other = (PerceivedLaneBasedObjectBase) obj;
