 ...
 * <p>
 * This class stores the initial space headway deficit (gamma_s) and the speed difference
 * (gamma_v) after a lane change or cut-in. It provides exponentially decaying virtual
 * buffers for both distance and speed. This represents the "2p" (two-parameter) relaxation
 * model, allowing independent decay rates for space and speed errors.
 * </p>
 * <p>
...
public class RelaxationState
{
     ...
     * <p>
     * The virtual buffer decays exponentially based on elapsed time and Tau_v.
     * This buffer can be negative if the new leader was faster than the old leader.
     * </p>
     *
     * @param currentTime the current absolute simulation time
    ...
    public Speed getVirtualSpeedBuffer(final Duration currentTime)
    {
        ...
        return new Speed(bufferSi, SpeedUnit.SI);
    }
}