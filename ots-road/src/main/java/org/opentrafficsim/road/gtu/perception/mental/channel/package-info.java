/**
 * Mental implementation based on an Attention Matrix, determining attention over different channels. This model was designed as
 * part of the i4Driving project.
 * <p>
