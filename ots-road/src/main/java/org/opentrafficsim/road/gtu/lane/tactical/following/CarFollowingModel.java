...
public interface CarFollowingModel
{
     ...
     */
    Acceleration freeAcceleration(BehavioralCharacteristics behavioralCharacteristics, Speed speed, SpeedInfo speedInfo)
    ...
    Acceleration followingAcceleration(BehavioralCharacteristics behavioralCharacteristics, Speed speed,
        SpeedInfo speedInfo, Length.Rel headway, Speed leaderSpeed) throws ParameterException;

    /**
     * Multi-anticipative determination of car-following acceleration. The implementation should be able to deal with:<br>
     * <ul>
     * <li>The current speed being higher than the desired speed.</li>
     * <li>The headway being negative. The tactical planner determines whether multi-anticipative car-following is applied,
     * including to how many leaders and within what distance, by including these vehicles in the set. The car-following model
     * itself may however only respond to the first vehicle.
     * @param behavioralCharacteristics Behavioral characteristics.</li>
     *            </ul>
     * @param speed Current speed.
     * @param speedInfo Info regarding the desired speed for car-following.
