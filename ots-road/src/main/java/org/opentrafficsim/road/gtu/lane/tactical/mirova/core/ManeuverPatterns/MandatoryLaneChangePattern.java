...
public class MandatoryLaneChangePattern extends ManeuverPattern {
    ...
    public boolean checkAbility() {
        ...
        if (infraPerception.getLegalLaneChangePossibility(RelativeLane.CURRENT, this.targetDirection).si > 0.0) {
            ...
            System.out.println("MandatoryLaneChangePattern: lane change to " + this.targetDirection + " is possible.");
            return true;
        }
        else { return false; }
        }
    ...
    public static class GapCandidate {
        ...
        public GapCandidate(
            ...
            this.aM = aM;
            System.out.println("Created GapCandidate: " + this.toString());
        }
        ...
        public boolean checkGapStillValid(final MirovaTacticalPlanner egoVehicle, final MandatoryLaneChangePattern pattern)
            ...
            Length followerOverlap = this.follower.getOverlapFront();

            System.out.println("GTU " + egoVehicle.getGtu().getId() + ": follower is behind? " + this.follower.isBehind());
            System.out.println("GTU " + egoVehicle.getGtu().getId() + ": follower is ahead? " + this.follower.isAhead());
            if (this.follower. isBehind() || (followerOverlap != null && followerOverlap.si < 0.0)) {
                System.out.println("GTU " + egoVehicle.getGtu().getId() + ": Gap still valid check: follower is behind.");
                ...
                while (followerIt.hasNext())
                {
                    ...
                    if (followerI == this.follower) {
                        ...
                        System.out.println("GTU " + egoVehicle.getGtu().getId() + ": Gap still valid check: found follower match.");
                ...
                System.out.println("GTU " + egoVehicle.getGtu().getId() + ": Gap still valid check: follower is ahead ego");
                ...
                while (leaderIt.hasNext())
                {
                    ...
                    if (leaderI == this.leader) {
                        ...
                        System.out.println("GTU " + egoVehicle.getGtu().getId() + ": Gap still valid check: found leader match.");
            ...
            System.out.println("GTU " + egoVehicle.getGtu().getId() + ": Gap still valid check: no match found.");
            return false;
        ...
        public String toString() {
            return "GapCandidate[Leader ID=" + this.leader.getId() +
                   ", Follower ID=" + this.follower.getId() +
                   ", MergePoint=" + this.mergePoint +
                   ", aM=" + this.aM + "]";
        }
    }
