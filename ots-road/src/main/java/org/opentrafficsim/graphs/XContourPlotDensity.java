 ...
 */
public class XContourPlotDensity extends XAbstractContourPlot<LinearDensity>
{
     ...
     */
    public XContourPlotDensity(final String caption, final OTSSimulatorInterface simulator, final XContourDataPool dataPool)
    {
