/*
 * @(#) PanRightAction.java Oct 29, 2003 Copyright (c) 2002-2005 Delft
...
public class PanRightAction extends AbstractAction
{
     ...
     */
    public PanRightAction(final GridPanel target)
    {
        super("PanRight");
        this.target = target;
        this.putValue(Action.SMALL_ICON, new ImageIcon(URLResource.getResource("/toolbarButtonGraphics/navigation/Forward16.gif")));
    ...
    {
        this.target.pan(GridPanel.RIGHT, 0.1);
